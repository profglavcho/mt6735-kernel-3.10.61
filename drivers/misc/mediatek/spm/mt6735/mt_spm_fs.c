...
static ssize_t vcorefs_pcm_show(struct kobject *kobj, struct kobj_attribute *attr,
                               char *buf)
{
...
static ssize_t vcorefs_ctrl_show(struct kobject *kobj, struct kobj_attribute *attr,
                              char *buf)
{
