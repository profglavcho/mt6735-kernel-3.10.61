...
void PMIC_INIT_SETTING_V1(void)
{
    ...
    //--------------------------------------------------------
        ...
        PMICLOG("[Kernel_PMIC_INIT_SETTING_V1] 2015-01-22...\n");
...
ret = pmic_config_interface(0x204,0x1,0x1,6); // [6:6]: RG_OSC_SEL_HW_MODE; Luke, for Vsys PFM issue,0105
...
ret = pmic_config_interface(0x64C,0x1,0x1,8); // [8:8]: VSYS22_VSLEEP_EN; VSYS22 sleep mode in 0105,Luke
...
ret = pmic_config_interface(0xA64,0x0,0x3,4); // [5:4]: RG_VEMC_3V3_VOSEL; 
