...
// This check will be removed after refing smi_common.h

#ifdef SMI_LARB_NR
    #undef SMI_LARB_NR
#endif

#ifdef SMI_LARB0_PORT_NUM
    #undef SMI_LARB0_PORT_NUM
#endif

#ifdef SMI_LARB1_PORT_NUM
    #undef SMI_LARB1_PORT_NUM
#endif

#ifdef SMI_LARB2_PORT_NUM
    #undef SMI_LARB2_PORT_NUM
#endif

#ifdef SMI_LARB3_PORT_NUM
    #undef SMI_LARB3_PORT_NUM
#endif

#ifdef SMI_LARB4_PORT_NUM
    #undef SMI_LARB4_PORT_NUM
#endif
