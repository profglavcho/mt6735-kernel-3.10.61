...
void ccci_set_mem_access_protection(struct ccci_modem *md)
{
    ...
    //--------------+-------------------------------------------------------------------------------------------------------------
    // ATF          |    1   |RW(S)       |Forbidden   |Forbidden   |Forbidden  |Forbidden  |Forbidden   |Forbidden  |Forbidden  |
    //--------------+-------------------------------------------------------------------------------------------------------------
    // Not use      |    2   |NA          |NA          |NA          |NA         |NA         |NA          |NA         |NA         |
    //--------------+-------------------------------------------------------------------------------------------------------------
    ...
    //--------------+-------------------------------------------------------------------------------------------------------------
    // MD1 SMEM     |    9   |No protect  |No protect  |Forbidden   |Forbidden  |Forbidden  |Forbidden   |Forbidden  |Forbidden  |
    //--------------+-------------------------------------------------------------------------------------------------------------
    // MD2 log3G    |   10   |No protect  |Forbidden   |Forbidden   |Forbidden  |Forbidden  |No protect  |Forbidden  |Forbidden  |
    //--------------+-------------------------------------------------------------------------------------------------------------
    // Not use      |   11   |NA          |NA          |NA          |NA         |NA         |NA          |NA         |NA         |
    //--------------+-------------------------------------------------------------------------------------------------------------
    // WIFI EMI FW  |   12   |Forbidden   |Forbidden   |No protect  |Forbidden  |Forbidden  |No protect  |Forbidden  |Forbidden  |
    //--------------+-------------------------------------------------------------------------------------------------------------
    // WMT          |   13   |No protect  |Forbidden   |No protect  |Forbidden  |Forbidden  |No protect  |Forbidden  |Forbidden  |
    //--------------+-------------------------------------------------------------------------------------------------------------
    // MD1 R/W+     |   14   |Forbidden   |No protect  |Forbidden   |Forbidden  |Forbidden  |Forbidden   |Forbidden  |Forbidden  |
    //--------------+-------------------------------------------------------------------------------------------------------------
    // AP           |   15   |No protect  |Forbidden   |Forbidden   |Forbidden  |No protect |Forbidden   |No protect |Forbidden  |
    //============================================================================================================================
    switch(md->index) {
    case MD_SYS1:
        ...
        shr_mem_mpu_attr= SET_ACCESS_PERMISSON(FORBIDDEN, FORBIDDEN, FORBIDDEN, FORBIDDEN, FORBIDDEN, FORBIDDEN, NO_PROTECTION, NO_PROTECTION);            
        break;
    default:
        CCCI_ERR_MSG(md->index, CORE, "[error]invalid when MPU protect\n");
        return;
...
#endif
    ap_mem_mpu_id = MPU_REGION_ID_AP;
    ap_mem_mpu_attr = SET_ACCESS_PERMISSON(NO_PROTECTION, NO_PROTECTION, NO_PROTECTION,  NO_PROTECTION, NO_PROTECTION, NO_PROTECTION, SEC_R_NSEC_R, NO_PROTECTION);
