...
{ 
    ...
    if (_u4BSID[u4InstID] == 1) 
	{
        u4Bytes = u4VDEC_HAL_WMV_ReadRdPtr(0, u4InstID, (ULONG)_pucVFifo[u4InstID], &u4Bits);
        rWmvBSInitPrm.u4VFifoSa = (ULONG)_pucVFifo[u4InstID];
        rWmvBSInitPrm.u4VFifoEa = (ULONG)_pucVFifo[u4InstID] + V_FIFO_SZ;
        rWmvBSInitPrm.u4ReadPointer= (ULONG)_pucVFifo[u4InstID] + u4Bytes;
#ifndef  RING_VFIFO_SUPPORT
...
void vWMVSearchSliceStartCode(UINT32 u4InstID)
{
   ULONG u4PicStartAddr = ((ULONG) _pucVFifo[u4InstID]) + _u4CurrPicStartAddr[u4InstID];
   ...
   while (1)
   {
        ...
        if (((ULONG) pVideoData) >/*=*/ ((_tInFileInfo[u4InstID].u4FileLength + 64/*<< 3*/) + ((ULONG) _pucVFifo[u4InstID])) ) // tmp, enlarge 64 bytes for judgment
        {
...
BOOL fgWMVNextStartCode(UINT32 u4InstID)
{
    ...
    vVDEC_HAL_WMV_AlignRdPtr(_u4BSID[u4InstID], u4InstID, (ULONG)_pucVFifo[u4InstID], BYTE_ALIGN);
...
{
  prWmvDecBpPrm->rWmvWorkBufSa.u4Bp1Sa = (ULONG)_pucBp_1[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4Bp2Sa = (ULONG)_pucBp_2[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4Bp3Sa = (ULONG)_pucBp_3[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4Bp4Sa = (ULONG)_pucBp_4[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4Dcac2Sa = (ULONG)_pucDcac_2[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4DcacSa = (ULONG)_pucDcac[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4Mv12Sa = (ULONG)_pucMv_1_2[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4Mv1Sa = (ULONG)_pucMv_1[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4Mv2Sa = (ULONG)_pucMv_2[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4Mv3Sa = (ULONG)_pucMv_3[u4InstID];
}
else
{
  prWmvDecBpPrm->rWmvWorkBufSa.u4DcacNewSa = (ULONG)_pucDcacNew[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4MvNewSa    = (ULONG)_pucMvNew[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4Bp0NewSa   = (ULONG)_pucBp0New[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4Bp1NewSa   = (ULONG)_pucBp1New[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4Bp2NewSa   = (ULONG)_pucBp2New[u4InstID];
}

  prWmvDecBpPrm->rWmvWorkBufSa.u4Pic0CSa = (ULONG)_pucPic0C[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4Pic0YSa = (ULONG)_pucPic0Y[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4Pic1CSa = (ULONG)_pucPic1C[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4Pic1YSa = (ULONG)_pucPic1Y[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4Pic2CSa = (ULONG)_pucPic2C[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4Pic2YSa = (ULONG)_pucPic2Y[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4Pp1Sa = (ULONG)_pucPp_1[u4InstID];
  prWmvDecBpPrm->rWmvWorkBufSa.u4Pp2Sa = (ULONG)_pucPp_2[u4InstID];   
}
        ...
        else  // >= WMV3
        {
            ...
            else 
			{
                if (((prWMVPPS->ucFrameCodingMode == INTERLACEFIELD) &&
					( ((prWMVPPS->i4CurrentField == 0) && (prWMVICOMPPS->ucFrameTypeLastTop == IVOP)) ||
					((prWMVPPS->i4CurrentField == 1) && (prWMVICOMPPS->ucFrameTypeLastBot == IVOP)))
					) ||
                    ((prWMVPPS->ucFrameCodingMode != INTERLACEFIELD) &&  //ming modify @3/14
