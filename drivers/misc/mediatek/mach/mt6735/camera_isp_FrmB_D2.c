...
static MINT32 ISP_DumpReg_FrmB(MVOID)
{
    ...
    //spin_lock_irqsave(&(g_IspInfo_FrmB.SpinLock), flags);
    ...
    LOG_DBG("0x%08X %08X", ISP_TPIPE_ADDR + 0x0F8, ISP_RD32((void *)(ISP_ADDR + 0x0F8)));
    ...
    {
        LOG_DBG("0x%08X %08X ", (unsigned int)(ISP_ADDR + i), ISP_RD32(ISP_ADDR + i));
    }
    ...
    //CDP
    LOG_DBG("0x%08X %08X ",  (unsigned int)(ISP_ADDR + 0xCC0), ISP_RD32(ISP_ADDR + 0xCC0));
    LOG_DBG("0x%08X %08X ",  (unsigned int)(ISP_ADDR + 0xD40), ISP_RD32(ISP_ADDR + 0xD40));
    ...
    LOG_DBG("0x%08X %08X ",  (unsigned int)(ISP_ADDR_CAMINF), ISP_RD32(ISP_ADDR_CAMINF));
    LOG_DBG("0x%08X %08X ",  (unsigned int)(ISP_ADDR + 0x150), ISP_RD32(ISP_ADDR + 0x150));
    ...
    */
    ...
    //spin_unlock_irqrestore(&(g_IspInfo_FrmB.SpinLock), flags);
